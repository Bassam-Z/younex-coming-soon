...
<head>
  ...
  <script src="/services.js?v=1" defer></script>
</head>`;
}
...
const servicesDescription = 'خدمات توريد وتخصيص المعدات للتجار والشركات في سوريا: كميات تجارية، اختيار اللون، طباعة الشعار والعلامة التجارية، التغليف والتوصيل.';
  ...
  '@graph': [
    {
      ...
      serviceType: ['Bulk sourcing', 'Product customization', 'Private labeling', 'Commercial delivery']
    },
